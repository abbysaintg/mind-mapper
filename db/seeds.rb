...
child_node1 = Node.create(label: 'Child Node 1', x: 10.0, y: 10.0, color: '#000000', parent_id: 1, map: map1)
child_node2 = Node.create(label: 'Child Node 2', x: -10.0, y: 10.0, color: '#000000', parent_id: 1, map: map1)

puts "creating nodes for map #2"
root_node2 = Node.create(label: 'Root Node', x: 0.0, y: 0.0, color: '#000000', map: map2)
child_node1_2 = Node.create(label: 'Child Node 1', x: 10.0, y: 10.0, color: '#000000', parent_id: 1, map: map2)
